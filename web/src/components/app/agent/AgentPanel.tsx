            ...
            >
                ...
                <div className="flex-1 min-w-0 flex flex-col">
                    ...
                    >
                        ...
                        <span
                            className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full text-[10.5px] font-semibold border bg-emerald-50 border-emerald-200 text-emerald-700 ml-1 select-none"
                            title="OpenAI GPT-4o-mini is securely configured via server environment variables"
                        >
